...
class fProfile : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val _insertNama = view.findViewById<EditText>(R.id.insertNama)
        val _buttonSetNama = view.findViewById<Button>(R.id.buttonSetNama)

//        val mfProfile = fProfile()
//        val mFragmentManager = parentFragmentManager
//        mFragmentManager.beginTransaction().apply {
//
//        }

        _buttonSetNama.setOnClickListener{
            val intentToActivity1 = Intent(activity, MainActivity::class.java).apply{
            }
